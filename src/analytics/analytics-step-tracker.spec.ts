...
import AnalyticsStepTracker, { AnalyticStepId } from './analytics-step-tracker';
...
describe('AnalyticsStepTracker', () => {
    ...
    beforeEach(() => {
        ...
        analyticsStepTracker = new AnalyticsStepTracker(
            ...
            sessionStorage,
            analytics,
            { shouldBackfillPreviousSteps: true }
        );
    });
    ...
    describe('#trackStepViewed()', () => {
        ...
        describe('when custom step order is passed', () => {
            ...
            beforeEach(() => {
                analyticsStepTrackerCustomOrder = new AnalyticsStepTracker(
                    ...
                    analytics,
                    {
                        stepsOrder: ['shipping', 'billing', 'payment', 'customer'],
                        shouldBackfillPreviousSteps: true,
                    }
                );
            });
        ...
        describe('when shouldBackfillSteps is off', () => {
