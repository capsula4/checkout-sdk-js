...
describe('CheckoutButtonSelector', () => {
    ...
    describe('#isInitializing()', () => {
        ...
        it('returns true if initializing checkout button', () => {
            ...
            expect(selector.isInitializing(CheckoutButtonMethod.BRAINTREE_PAYPAL)).toEqual(true);
        });
        ...
        it('returns false if not initializing checkout button', () => {
            ...
            expect(selector.isInitializing(CheckoutButtonMethod.BRAINTREE_PAYPAL_CREDIT)).toEqual(false);
        });
    ...
    describe('#isDeinitializing()', () => {
        ...
        it('returns true if deinitializing checkout button', () => {
            ...
            expect(selector.isDeinitializing(CheckoutButtonMethod.BRAINTREE_PAYPAL)).toEqual(true);
        });
        ...
        it('returns false if not deinitializing checkout button', () => {
            ...
            expect(selector.isDeinitializing(CheckoutButtonMethod.BRAINTREE_PAYPAL_CREDIT)).toEqual(false);
        });
    ...
    describe('#getInitializeError()', () => {
        ...
        it('returns error if unable to initialize checkout button', () => {
            ...
            expect(selector.getInitializeError(CheckoutButtonMethod.BRAINTREE_PAYPAL)).toEqual(expectedError);
        });
        ...
        it('returns undefined if able to initialize checkout button', () => {
            ...
            expect(selector.getInitializeError(CheckoutButtonMethod.BRAINTREE_PAYPAL_CREDIT)).toBeUndefined();
        });
    ...
    describe('#getDeinitializeError()', () => {
        ...
        it('returns error if unable to deinitialize checkout button', () => {
            ...
            expect(selector.getDeinitializeError(CheckoutButtonMethod.BRAINTREE_PAYPAL)).toEqual(expectedError);
        });
        ...
        it('returns undefined if able to deinitialize checkout button', () => {
            ...
            expect(selector.getDeinitializeError(CheckoutButtonMethod.BRAINTREE_PAYPAL_CREDIT)).toBeUndefined();
        });
